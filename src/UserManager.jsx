...
function Row({u,patch,resetPin}){const [pin,setPin]=useState("");const col=u.color||"#58a6ff";return <div style={{display:"grid",gridTemplateColumns:"34px minmax(0,1.4fr) minmax(0,.55fr) minmax(0,.65fr) minmax(0,.8fr) minmax(0,1fr)",gap:8,alignItems:"center",padding:"6px 8px",background:"rgba(255,255,255,.018)",borderRadius:5,marginTop:4}}>
