...
<button onClick={()=>{
if(pendingDel.id===”**SELECTED**”){[…selVessels].forEach(v=>onDelV(v));setSelVessels(new Set());}
...
if(pendingDel.id===”**SELCARGO**”){[…selCargoes].forEach(id=>onDelC(id));setSelCargoes(new Set());}
else onDelC(”**ALLCARGO**”);
}
setPendingDel(null);
...
{tab===“pos”&&vessels.length>0&&(<button onClick={()=>setPendingDel({type:“all”,id:”**ALL**”,label:“ALL “+vessels.length+” vessels”})} style={{background:“none”,border:“1px solid “+C.bd,borderRadius:4,padding:“2px 10px”,color:C.dim,fontSize:12,cursor:“pointer”,fontFamily:“inherit”}}>✕ Clear Positions</button>)}
</div>
</div>
