...
/>
                  ...
                  {/* Side panel — fixed to right edge, pure CSS, no re-render on scroll */}
                  {selV&&(
                    <div style={{width:260,background:C.bg2,border:"1px solid "+C.bd,borderRadius:7,overflow:"hidden",position:"fixed",right:16,top:90,zIndex:1000,maxHeight:"calc(100vh - 110px)",display:"flex",flexDirection:"column",boxShadow:"0 16px 50px rgba(0,0,0,0.7)"}}>
