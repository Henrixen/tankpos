            ...
            {[
              ...
              <button key={id} onClick={()=>{setTab(id);setBucketFilters(new Set());}}
                style={{display:"flex",flexDirection:"column",alignItems:"center",gap:4,
                  minWidth:mobile?70:95,padding:"10px 8px",borderRadius:8,
                ...
                <div style={{display:"flex",alignItems:"center",gap:12,padding:"6px 10px",background:C.bg3,border:"1px solid "+C.bd2,borderRadius:6,fontSize:12,flexWrap:"wrap"}}>
                  ...
                  {selVessels.size>0&&(
                    <button 
                      ...
                      style={{fontSize:12,fontWeight:700,padding:"4px 12px",borderRadius:5,border:"1px solid #6366f1",background:"rgba(99,102,241,.12)",color:"#6366f1",cursor:"pointer",fontFamily:"inherit",whiteSpace:"nowrap"}}>
                      📋 Export to Report ({selVessels.size})
                    </button>
                  )}
            ...
            <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
              ...
              {selCargoes.size>0&&(
                <button 
                  onClick={()=>setTab("reports")}
                  style={{fontSize:12,fontWeight:700,padding:"4px 12px",borderRadius:5,border:"1px solid #6366f1",background:"rgba(99,102,241,.12)",color:"#6366f1",cursor:"pointer",fontFamily:"inherit",whiteSpace:"nowrap"}}>
                  📋 Export to Report ({selCargoes.size})
                </button>
              )}
              {selCargoes.size>0&&(
