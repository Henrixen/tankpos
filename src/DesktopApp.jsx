...
/>
                  ...
                  {/* Side panel — fixed, beside table aligned with table top */}
                  {selV&&(
                    <div style={{width:260,background:C.bg2,border:"1px solid "+C.bd,borderRadius:7,overflow:"hidden",position:"fixed",left:"min(540px, calc(100vw - 290px))",top:160,zIndex:1000,maxHeight:"calc(100vh - 180px)",display:"flex",flexDirection:"column",boxShadow:"0 16px 50px rgba(0,0,0,0.7)"}}>
