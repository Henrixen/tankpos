...
/>
                  ...
                  {/* Side panel */}
                  {selV&&(
                    <div style={{width:240,flexShrink:0,background:C.bg2,border:"1px solid "+C.bd,borderRadius:7,overflow:"hidden",position:"fixed",top:56,right:16,zIndex:9000,maxHeight:"calc(100vh - 70px)",display:"flex",flexDirection:"column",boxShadow:"0 8px 28px rgba(0,0,0,0.6)"}}>
