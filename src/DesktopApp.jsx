            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{textAlign:"center",marginBottom:mobile?14:16}}>
                    {mobile ? (
                      <div style={{fontSize:17,fontWeight:850,color:"#eef6ff"}}>Enter code to access <span style={{color:"#43e97b"}}>Dashboard</span></div>
                    ) : (<>
                  ...
                  <div style={{display:"flex",gap:mobile?7:9,justifyContent:"center",marginBottom:mobile?10:15}}>
                    {[0,1,2,3].map(i=><div key={i} style={{
                      width:mobile?60:54,height:mobile?66:46,borderRadius:8,
