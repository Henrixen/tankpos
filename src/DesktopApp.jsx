...
const filtV=useMemo(()=>{
  ...
  <div style={{minHeight:180,maxHeight:600,resize:"vertical",overflow:"auto"}}><ParsePanel vessels={vessels} onAddVessels={onAddVessels} onAddCargoes={onAddCargoes} lockedMode="pos" vesselDB={{}}/></div>
  <div><FixingWindow vessels={filtV} opFilter={opFilter} onOpFilter={op=>setOpFilter(o=>o===op?null:op)} /></div>
              ...
              {!mobile&&(
                <div style={{width:"34%",background:C.bg2,border:"1px solid "+C.bd,borderRadius:7,overflow:"hidden",display:"flex",flexDirection:"column",alignSelf:"flex-start"}}>
                  ...
                  <div style={{padding:"8px 10px",height:400,overflowY:"hidden"}}>
                    <RateMatrix/>
                  </div>
                </div>
              )}
