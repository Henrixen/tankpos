  ...
  return(
    <div style={{background:C.bg2,border:"1px solid "+C.bd,borderRadius:7,overflow:"hidden"}}>
      ...
      <textarea value={text} onChange={e=>setText(e.target.value)} onPaste={onPaste}
        ...
        style={{width:"100%",minHeight:115,background:C.bg2,border:"none",color:C.tx,fontFamily:"inherit",fontSize:12,padding:"6px 10px",resize:"none",outline:"none",boxSizing:"border-box"}}/>
